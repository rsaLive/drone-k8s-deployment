...
type PConfig struct {
	...
	Image         string `envName:"DOCKER_IMAGE"`

	BuildNumber      string `envName:"DRONE_BUILD_NUMBER"`
	...
	BuildRepo        string `envName:"PLUGIN_BUILD_REPO"`
	CommitBranch     string `envName:"DRONE_COMMIT_BRANCH"`
}
